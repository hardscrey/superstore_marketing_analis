...
![Распределение заказов по Discount Groups](https://github.com/hardscrey/superstore_marketing_analis/blob/main/images/discount_group.png)
[Ссылка на файл](discount_group.png)
...
![Помесячная агрегация стоимости и прибыли](https://github.com/hardscrey/superstore_marketing_analis/blob/main/images/monthly_sales_profit.png)
[Ссылка на файл](monthly_sales_profit.png)

- По дням недели: пик продаж — будни, спад — выходные.
![Средняя стоимость по дням недели](https://github.com/hardscrey/superstore_marketing_analis/blob/main/images/mean_sales_by_d.png)
[Ссылка на файл](mean_sales_by_d.png)
...
[Срденяя скидка и маржа по категориям](https://github.com/hardscrey/superstore_marketing_analis/blob/main/images/discount_vs_margin_by_category.png)
[Ссылка на файл](discount_vs_margin_by_category.png)
